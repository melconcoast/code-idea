...
Thanks for considering a contribution. This skill is small on purpose — most useful contributions will be sharpening what's already here, not adding new files.
...
There's no automated test suite — this is a markdown-based skill, not code. To validate a change:
